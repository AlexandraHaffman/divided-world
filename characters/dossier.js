...
const TIER_FILTER_COLORS = {
  ...
  elite:     { hex: "#818cf8", rgb: "129,140,248" },
...
const LEGENDARY_DOSSIER_SLUGS = { "Элиас Дорн": "dorn/dorn", "Курт Вистнер": "wistner/wistner", "Эмиль Грант": "emil/emil", "Дариан Сорель": "darian/darian", "Лилия Спасская": "liliya/liliya", "Амели Бертран": "ameli-bertrand/ameli-bertrand", "Ольга Гончарова": "olga-goncharova/olga-goncharova" };
...
function buildTierFilters() {
  ...
  ["common","rare","elite","epic","legendary","mythical","divine"].forEach(t => {
