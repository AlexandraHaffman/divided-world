...
// ── Столицы провинций Forge ───────────────────────────────────────
  ...
  },
  {
    ...
    lat: 69.165,
    lon: 35.135,
    subtitle: "Териберка, Мурманский берег",
    population: "10 тыс.",
    status: "Анклав на побережье Белой зоны, в 1300 км к востоку от владений Тенебриона",
    desc: "Териберка и соседние губы баренцевоморского берега — Лодейная, Орловка, Завалишина. Северный конец морской линии Гавани и единственная её незамерзающая гавань за полярным кругом: тёплое течение держит рейд открытым круглый год, а глубокие узкие губы прячут стоянки от ветра и чужих глаз.",
