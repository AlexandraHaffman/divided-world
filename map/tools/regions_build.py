...
HOLDINGS = {
  ...
  "guilin": {
    "parent": "rift",
    "shape": [(26.45, 110.00), (26.32, 110.52), (26.34, 110.92), (26.00, 111.18),
              (25.62, 111.38), (25.30, 111.20), (25.06, 111.30), (24.96, 110.95),
              (24.90, 110.50), (25.04, 110.10), (24.98, 109.72), (25.26, 109.48),
              (25.62, 109.58), (25.96, 109.42), (26.22, 109.70)],
  },
  # Коридор идёт по самой реке: осевая от Наньнина через Гуйпин и Учжоу
  # до восточного края домена, шириной примерно в шестьдесят километров.
  # Уже владения и заметно уже сектора — чтобы на карте три очертания
  # не сливались в одну кучу линий.
  "xijiang": {
    "parent": "rift",
