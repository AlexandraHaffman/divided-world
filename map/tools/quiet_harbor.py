...
анклавов. Поэтому на карте у неё не полигоны стран, а:
  * зона влияния вокруг каждого Дома — эллипс, вытянутый по берегу
    ...
    северо-восток, Андаманы — с севера на юг, Мурманский берег —
    почти точно на восток);
  * морские пути между Домами — магистраль от Мурманского берега
    до Хайнаня и три ответвления: в Балтику, в Чёрное море и в
    Персидский залив.
...
HOUSES = [
  ...
  ("fjord",    "Дом фьордов",   69.165,  35.135, 45, 20, 110),
]

# ═══════════════ МОРСКИЕ ПУТИ ═══════════════
# Магистраль идёт от Териберки вокруг Нордкапа и Европы, через Суэц и
# Малаккский пролив до Саньи; Дома кораллов и муссонов стоят прямо на ней.
TRUNK = [
  (69.165, 35.135), (70.30, 33.20), (71.00, 30.00), (71.50, 26.00),
  (71.30, 21.50), (70.60, 17.50), (69.20, 14.00), (67.50, 11.50),
  (66.0, 10.0), (64.0, 7.0), (62.0, 4.5),
